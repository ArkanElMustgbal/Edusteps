...
(function (global) {
  ...
  addAll({
    'إديو ستبس العالمية': 'Edusteps International',
    'رياض ومدارس إديو ستبس العالمية': 'Edusteps International Kindergartens & Schools',
    'Edusteps — إديو ستبس العالمية': 'Edusteps — Edusteps International',
    'رياض ومدارس إديو ستبس العالمية. جميع الحقوق محفوظة.': 'Edusteps International Kindergartens & Schools. All rights reserved.',
    'النظام المحاسبي المدرسي | إديو ستبس العالمية': 'School Accounting System | Edusteps International',
    'النظام المحاسبي | إديو ستبس العالمية': 'Accounting System | Edusteps International',
    'إديو ستبس': 'Edusteps',
    'المملكة العربية السعودية': 'Kingdom of Saudi Arabia',
  });

  // ---- تلميح بيانات الدخول الافتراضية في شاشة الدخول ----
  addAll({
    '🔐 بيانات الدخول الافتراضية: ': '🔐 Default login credentials: ',
    'يمكن تغييرها من تبويب الإعدادات بعد الدخول.': 'They can be changed from the Settings tab after logging in.',
  });
